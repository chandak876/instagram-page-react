...
function Profile() {
    ...
    const renderProfilePicture = () => {
        return (
            <img alt="profile" className="profile-picture" src="/assets/icons/profile-pic.jpeg"/>
        );
    }
    ...
    const renderProfileContentUser = () => {
        return (
            <div className="inline">
                ...
                <a href="#" className={isFollow? "profile-content-follow" : "profile-content-unfollow"} onClick={handleClickFollowButton}>{followButtonText}</a>
            </div>
        );
    }
